...
VALUES
    ...
    ('Samuel Adams Boston Lager', 'Boston Beer Company', 'A full-bodied amber lager with a rich, malty flavor.', 'Amber', 'Boston Beer Company', 'USA', 5.0, 30, 'Burgers, Chicken', '6-8°C', 'Pint Glass', 'Malty, Hoppy, Balanced', 4.49, 0, 10),
